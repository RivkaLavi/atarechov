...
switch( $portfolio_detail_page_head_style ) :
	case 'featured_image' :
		$portfolio_about_sentence = esc_html__( "About this project", 'listopia' );
	break;
...
function jvbpd_portfolio_meta(){
	...
	if ($portfolio_detail_page_head_style=='title_upper_content'):
		...
		echo '<h3>' .esc_html__( "About this project", 'listopia' ). '</h3>';
	endif;
