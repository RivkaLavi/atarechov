...
class jvbpd_Header_Func {
	...
	public function header_type_options( $options ) {
		return wp_parse_args(
			Array(
				esc_html__( "Dashboard Style", 'listopia' ) => 'dashboard-style',
				esc_html__( "1 Row (inline) type", 'listopia' ) => 'inline',
				esc_html__( "1 Row (inline clean) type", 'listopia' ) => 'inline-clean',
				esc_html__( "2 Rows type (Right Banner)", 'listopia' ) => 'jv-nav-row-2',
				esc_html__( "2 Rows logo center (M)", 'listopia' ) => 'jv-nav-row-2-second',
				esc_html__( "2 Rows search center", 'listopia' ) => 'jv-nav-row-2-search',
				esc_html__( "2 Rows bottom search", 'listopia' ) => 'jv-nav-row-2-bottom-search',
				esc_html__( "Vertical type", 'listopia' ) => 'jv-vertical-nav',
			), $options
		);
	}
