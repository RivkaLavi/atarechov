...
class jvbpd_Contact_Us extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			esc_html__('[JAVO] Contact Us', 'listopia' ), // Name
			array( 'description' => esc_html__( 'Javo contact information display widget.', 'listopia' ), ) // Args
		);
	}
	/**
	...
	public function form( $instance ) {
		if ( isset( $instance[ 'title' ] ) ) {
			...
			$title = esc_html__( 'Contact info', 'listopia' );
		}
		?>
		<p>
