...
class jvbpd_Recent_Photos_widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array(
			'description' => esc_html__( 'Recent Photos with thumbnails widget.', 'listopia' )
		);
                parent::__construct( 'jvbpd_recent_photos', esc_html__('[JAVO] Recent Photos','listopia' ), $widget_ops );
	}
	/**
	 * Display widget
	 */
	...
	?>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title:', 'listopia' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
		</p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'limit' ) ); ?>"><?php esc_html_e( 'Limit:', 'listopia' ); ?></label>
