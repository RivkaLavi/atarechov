	...
	<div class="javo-quick-contact-us-content">
		...
		if(
			...
			$jvbpd_contact_form_shortcode = sprintf(
				...
				, esc_html__( 'Javo Contact Form', 'listopia' )
			);
			...
			<div class="alert alert-light-gray">
				<strong><?php esc_html_e('Please create a form with contact 7 or Ninja form and add.', 'listopia' );?></strong>
				<p><?php esc_html_e('Theme Settings > General > Contact Form Modal Settings', 'listopia' );?></p>
			</div>
			<?php
		} ?>
	</div>
