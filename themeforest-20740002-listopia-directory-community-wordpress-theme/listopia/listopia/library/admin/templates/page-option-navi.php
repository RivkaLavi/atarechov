...
<table class="widefat">
	...
	<?php if( jvbpd_layout()->getThemeType() == 'jvd-lk' ) : ?>
		<tr>
			<td valign="middle"><?php esc_html_e( "Topbar", 'listopia' );?></td>
			<td valign="middle">
		...
		<tr id="topbar_height_field" class="hidden">
			<td valign="middle"><?php esc_html_e( "Topbar Height", 'listopia' );?></td>
			<td valign="middle">
				<table class="javo-post-header-meta">
					<tr>
						<td width="5%" valign="middle">
		...
		<tr id="topbar_bg_color_field" class="hidden">
			<td valign="middle"><?php esc_html_e( "Topbar Background Color", 'listopia' );?></td>
			<td valign="middle">
				<table class="javo-post-header-meta">
					<tr>
						<td width="5%" valign="middle">
		...
		<tr id="topbar_text_color_field" class="hidden">
			<td valign="middle"><?php esc_html_e( "Topbar Text Color", 'listopia' );?></td>
			<td valign="middle">
				<table class="javo-post-header-meta">
					<tr>
						<td width="5%" valign="middle">
		...
		<tr id="topbar_logo_field" class="hidden">
			<td valign="middle"><p><?php esc_html_e("Topbar Logo", 'listopia' );?></p></td>
			<td valign="middle">
				<div class="jv-uploader-wrap" style="padding-left:12px;">
					...
					<button type="button" class="button button-primary upload" data-title="<?php esc_html_e( "Select Background Image", 'listopia' ); ?>" data-btn="<?php esc_html_e( "Select", 'listopia' ); ?>">
						<span class="dashicons dashicons-admin-appearance"></span>
						<?php esc_html_e( "Select Background Image", 'listopia' ); ?>
					</button>
					<button type="button" class="button remove">
						<?php esc_html_e( "Delete", 'listopia' );?>
					</button>
					<h4><?php esc_html_e("Preview",'listopia' ); ?></h4>
		...
		<tr>
			<td valign="middle"><p><?php esc_html_e("Header Type", 'listopia' );?></p></td>
			<td valign="middle">
				<table class="javo-post-header-meta">
					<tr>
						...
						<td width="50%" valign="middle">
							<small class="description">
								<?php esc_html_e("If color value is not inserted, it will be replaced to color set from theme settings", 'listopia' );?>
							</small>
						</td>
					</tr>
				</table>
	...
	<tr>
		<td valign="middle"><p><?php esc_html_e("Navi Type", 'listopia' );?></p></td>
		<td valign="middle">
			<table class="javo-post-header-meta">
				<tr>
					<td width="50%" valign="middle">
					...
					<td width="50%" valign="middle">
						<small class="description"><?php esc_html_e("Caution: If you choose transparent menu type, page's main text contents ascends as much as menu's height to make menu transparent.", 'listopia' );?></small>
					</td>
				</tr>
			</table>
		</td>
	...
	<tr id="header_banner_field" class="hidden">
		<td valign="middle"><p><?php esc_html_e("Header Banner", 'listopia' );?></p></td>
		<td valign="middle">
			<div class="jv-uploader-wrap" style="padding-left:12px;">
				<input type="text" name="jvbpd_hd[header_banner]" value="<?php echo esc_attr( $jvbpd_query->get('header_banner'));?>" >
				<button type="button" class="button button-primary upload" data-title="<?php esc_attr_e( "Select Background Image", 'listopia' ); ?>" data-btn="<?php esc_attr_e( "Select", 'listopia' ); ?>">
					<span class="dashicons dashicons-admin-appearance"></span>
					<?php esc_html_e( "Select Background Image", 'listopia' ); ?>
				</button>
				<button type="button" class="button remove">
	...
	<tr>
		<td valign="middle"><p><?php esc_html_e( "Logo", 'listopia' );?></p></td>
		<td valign="middle">
			<table class="javo-post-header-meta">
				<tr>
					<td width="50%" valign="middle">
						<div class="jv-uploader-wrap" style="padding-left:12px;">
							...
							<button type="button" class="button button-primary upload" data-title="<?php esc_html_e( "Select Logo", 'listopia' ); ?>" data-btn="<?php esc_html_e( "Select", 'listopia' ); ?>">
								<span class="dashicons dashicons-admin-appearance"></span>
								<?php esc_html_e( "Select Logo", 'listopia' ); ?>
							</button>
							<button type="button" class="button remove">
								<?php esc_html_e( "Delete", 'listopia' );?>
							</button>
					...
					<td width="50%" valign="middle">
						<small class="description">
							<?php esc_html_e( "A custom logo for this page", 'listopia' );?>
						</small>
					</td>
				</tr>
			</table>
	...
	<tr>
		<td valign="middle"><p><?php esc_html_e("Header Menu Skin", 'listopia' );?></p></td>
		<td valign="middle">
			<table class="javo-post-header-meta">
				<tr>
					<td width="50%" valign="middle">
					...
					<td width="50%" valign="middle">
						<small class="description">
							<?php esc_html_e("Depends on this option, logo changes to the color appropriate to the skin and if selected logo of skin option is not uploaded, theme's basic logo will be shown.", 'listopia' );?>
						</small>
					</td>
				</tr>
			</table>
	...
	<tr class="alternate">
		<td valign="middle"><p><?php esc_html_e("Initial Header Background Color", 'listopia' );?></p></td>
		<td valign="middle">
			<table class="javo-post-header-meta">
				<tr>
					<td width="50%" valign="middle">
	...
	<tr>
		<td valign="middle"><p><?php esc_html_e("Initial Header Transparency", 'listopia' );?></p></td>
		<td valign="middle">
			<table class="javo-post-header-meta">
				<tr>
					...
					<td width="50%" valign="middle">
						<small class="description">
							<?php esc_html_e("Please enter numerical value from 0.0 to 1.0. The higher the value you enter, the more opaque it will be. Ex. 1=opaque, 0= invisible.", 'listopia' );?>
						</small>
					</td>
				</tr>
			</table>
	...
	<?php if( jvbpd_layout()->getThemeType() == 'jvd-lk' ) : ?>
		<tr>
			<td valign="middle"><p><?php esc_html_e("Header Height", 'listopia' );?></p></td>
			<td valign="middle">
				<table class="javo-post-header-meta">
					<tr>
						<td width="25%" valign="middle">
						...
						<td width="50%" valign="middle">
							<small class="description"><?php esc_html_e( "Pixcel", 'listopia' ); ?></small>
						</td>
					</tr>
				</table>
			</td>
	...
	<?php endif; ?>
	<tr>
		<td valign="middle"><p><?php esc_html_e("Navi Shadow", 'listopia' );?></p></td>
		<td valign="middle">
			<table class="javo-post-header-meta">
				<tr>
					<td width="50%" valign="middle">
	...
	<tr>
		<td valign="middle"><p><?php esc_html_e("Navi Position", 'listopia' );?></p></td>
		<td valign="middle">
			<table class="javo-post-header-meta">
				<tr>
					<td width="50%" valign="middle">
						<select name="jvbpd_hd[header_fullwidth]">
							...
							{
								printf( "<option value='{$value}' %s>{$label}</option>", selected( $value == $jvbpd_query->get( 'header_fullwidth', 'full' ), true, false ) );
							} ?>
						</select>
					</td>
					<td width="50%" valign="middle">
