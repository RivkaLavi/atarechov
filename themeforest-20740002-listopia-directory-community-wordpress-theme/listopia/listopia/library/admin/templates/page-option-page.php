...
<div id="postcustomstuff">
	<table id="list-table">
		<thead>
			<tr>
				<th class="left"><?php esc_html_e('Option Name', 'listopia' );?></th>
				<th><?php esc_html_e('Value', 'listopia' );?></th>
			</tr>
		</thead>
		<tbody id="the-list" data-wp-lists="list:meta">
			<tr>
				<td valign="middle"><p><?php esc_html_e( "Footer Layout Type", 'listopia' );?></p></td>
				<td valign="middle">
