<table class="widefat">
	<tr>
		<td colspan="2">
			<h2><?php esc_html_e("Sticky Options", 'listopia' );?></h2>
		</td>
	</tr>
	<tr>
		<td valign="middle"><p><?php esc_html_e("Sticky Navi on / off", 'listopia' );?></p></td>
		<td valign="middle">
	...
	<tr>
		<td valign="middle"><p><?php esc_html_e("Sticky Header Menu Skin", 'listopia' );?></p></td>
		<td valign="middle">
			<table class="javo-post-header-meta">
				<tr>
					<td width="50%" valign="middle">
	...
	<tr class="alternate">
		<td valign="middle"><p><?php esc_html_e("Initial Sticky Header Background Color", 'listopia' );?></p></td>
		<td valign="middle">
			<table class="javo-post-header-meta">
				<tr>
					<td width="50%" valign="middle">
	...
	<tr>
		<td valign="middle"><p><?php esc_html_e("Initial Sticky Header Transparency", 'listopia' );?></p></td>
		<td valign="middle">
			<table class="javo-post-header-meta">
				<tr>
					<td width="25%">
