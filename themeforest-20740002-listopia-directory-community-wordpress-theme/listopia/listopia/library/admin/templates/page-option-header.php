...
$jvbpd_fancy_dft_opt						= Array(
	'repeat'							=> Array(
		esc_html__("no-repeat", 'listopia' )		=> 'no-repeat'
		, esc_html__("repeat-x", 'listopia' )		=> 'repeat-x'
		, esc_html__("repeat-y", 'listopia' )		=> 'repeat-y'
	)
	, 'background-position-x'			=> Array(
		esc_html__("Left", 'listopia' )			=> 'left'
		, esc_html__("Center", 'listopia' )		=> 'center'
		, esc_html__("Right", 'listopia' )		=> 'right'
	)
	, 'background-position-y'			=> Array(
		esc_html__("top", 'listopia' )			=> 'top'
		, esc_html__("Center", 'listopia' )		=> 'center'
		, esc_html__("Bottom", 'listopia' )		=> 'bottom'
	)
);
...
if( class_exists( 'RevSlider' ) ) :
	...
	$strOutputSliderLists[]	= sprintf( "<option value=''>%s</option>", esc_html__( "Select Slider", 'listopia' ) );
	if( !empty( $arrSliderItems ) ) : foreach( $arrSliderItems as $slider ) {
		...
		$strOutputSliderLists[]	= sprintf( "<optgroup label=\"%s\"></optgroup>", esc_html__( "Empty Slider", 'listopia' ) );
	endif;
	$strOutputSliderLists[]	='</select>';
else:
	$strOutputSliderLists[]	= sprintf(
		'<label>%s</label>',
		esc_html__( "Please install revolition slider plugin or create slide item." , 'listopia' )
	);
endif;
...
$jvbpd_pageHeaderOptions	= Array(
	'op_h_title_show'				=> Array(
		'value'							=> 'default',
		'label'							=> esc_html__( "Show page title", 'listopia' ),
	),
	'op_h_title_hide'					=> Array(
		'value'							=> 'notitle',
		'label'							=> esc_html__( "Hide page title", 'listopia' ),
	),
	'op_h_title_fancy'				=> Array(
		'value'							=> 'fancy',
		'label'							=> esc_html__( "Fancy Header", 'listopia' ),
	),
	'op_h_title_slide'				=> Array(
		'value'							=> 'slider',
		'label'							=> esc_html__( "Slide Show", 'listopia' ),
	),
);
...
<div id="jvbpd_post_header_fancy">
	<div class="">
		<label class="jvbpd_pmb_option fancy op_f_left active">
			<span class="ico_img"></span>
			<p><input name="jvbpd_opt_fancy" type="radio" value="left" checked="checked"> <?php esc_html_e("Title left",'listopia' ); ?></p>
		</label>
		<label class="jvbpd_pmb_option fancy op_f_center">
			<span class="ico_img"></span>
			<p><input name="jvbpd_opt_fancy" type="radio" value="center"> <?php esc_html_e("Title center",'listopia' ); ?></p>
		</label>
		<label class="jvbpd_pmb_option fancy op_f_right">
			<span class="ico_img"></span>
			<p><input name="jvbpd_opt_fancy" type="radio" value="right"> <?php esc_html_e("Title right",'listopia' ); ?></p>
		</label>
	</div>
	<hr>
	<div class="jvbpd_pmb_field">
		<dl>
			<dt><label for="jvbpd_fancy_field_title"><?php esc_html_e("Title",'listopia' ); ?></label></dt>
			<dd><input name="jvbpd_fancy[title]" id="jvbpd_fancy_field_title" type="text" value="<?php echo esc_attr($jvbpd_fancy->get('title') );?>"></dd>
		</dl>
		<dl>
			<dt><label for="jvbpd_fancy_field_title_size"><?php esc_html_e("Title Size",'listopia' ); ?></label></dt>
		...
		<dl>
			<dt><label for="jvbpd_fancy_field_title_color"><?php esc_html_e("Title Color",'listopia' ); ?></label></dt>
			<dd>
		...
		<dl>
			<dt><label for="jvbpd_fancy_field_subtitle"><?php esc_html_e("Subtitle",'listopia' ); ?></label></dt>
		...
		<dl>
			<dt><label for="jvbpd_fancy_field_subtitle_size"><?php esc_html_e("Subtitle Size",'listopia' ); ?></label></dt>
		...
		<dl>
			<dt><label for="jvbpd_fancy_field_subtitle_color"><?php esc_html_e("Subtitle color",'listopia' ); ?></label></dt>
		...
		<hr>
		<dl>
			<dt><label for="jvbpd_fancy_field_bg_color"><?php esc_html_e("Background color",'listopia' ); ?></label></dt>
		...
		<dl>
			<dt><label for="jvbpd_fancy_field_bg_image"><?php esc_html_e("Background Image",'listopia' ); ?></label></dt>
			<dd>
		...
		<dl>
			<dt><label for="jvbpd_fancy_field_position_x"><?php esc_html_e("Position X",'listopia' ); ?></label></dt>
			<dd>
		...
		<dl>
			<dt><label for="jvbpd_fancy_field_position_y"><?php esc_html_e("Position Y",'listopia' ); ?></label></dt>
			<dd>
		...
		<hr>
		<dl>
			<dt><label for="jvbpd_fancy_field_fullscreen"><?php esc_html_e("Height(pixel)",'listopia' ); ?> </label></dt
			>
...
<div id="jvbpd_post_header_slide">
	<div class="">
		<label class="jvbpd_pmb_option slider op_d_rev active">
			<span class="ico_img"></span>
			<p><input name="jvbpd_opt_slider" type="radio" value="rev" checked="checked"> <?php esc_html_e("Revolution",'listopia' ); ?></p>
		</label>
	</div>
	...
	<div class="jvbpd_pmb_tabs slider jvbpd_pmb_field">
		<div class="jvbpd_pmb_tab active" tab="rev">
			<dl>
				<dt><label><?php esc_html_e("Choose slider",'listopia' ); ?></label></dt>
