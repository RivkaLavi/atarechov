...
class jvbpd_custom_nav {
	...
	public function getAppendMenus() {
		return Array(
			array(
				'name' => esc_html__( 'My Menu', 'listopia' ),
				'slug' => 'my_menu',
				'link' => "#"
			),
			array(
				'name' => esc_html__( 'My Notifications', 'listopia' ),
				'slug' => 'my_notifications',
				'link' => "#"
			),
			array(
				'name' => esc_html__( 'Add New Button', 'listopia' ),
				'slug' => 'add_new_button',
				'link' => "#"
			),
			array(
				'name' => esc_html__( 'Right sidebar opener', 'listopia' ),
				'slug' => 'right_sidebar_opener',
				'link' => "#"
			),
			array(
				'name' => esc_html__( 'Social Link', 'listopia' ),
				'slug' => 'socal_link',
				'link' => "#"
			),
			array(
				'name' => esc_html__( 'Search', 'listopia' ),
				'slug' => 'search_in_nav',
				'link' => "#"
			),
		);
	...
	public function add_nav_menu_meta_box() {
		add_meta_box( 'custom-javo-nav-menu', esc_html__( 'Javo', 'listopia' ), array( $this, 'nav_menu_meta_box' ), 'nav-menus', 'side', 'default' );
	}
	...
	public function nav_menu_meta_box() {
		...
		$menu_items[] = array(
			'name' => esc_html__( 'Login', 'listopia' ),
			'slug' => 'login',
			'link' => '#'
		);
		$menu_items[] = array(
			'name' => esc_html__( 'Logout', 'listopia' ),
			'slug' => 'logout',
			'link' => "#"
		);
		$menu_items[] = array(
			'name' => esc_html__( 'Register', 'listopia' ),
			'slug' => 'register',
			'link' => "#"
		);
		...
		if (!empty($menu_items)) {
			...
			esc_html_e( 'No items available here for the moment' , 'listopia' );
			return;
		}
		...
		<div id="jvbpd-menu" class="posttypediv">
			...
			<p class="button-controls">
				<span class="add-to-menu">
					<input type="submit"<?php if ( function_exists( 'wp_nav_menu_disabled_check' ) ) : wp_nav_menu_disabled_check( $nav_menu_selected_id ); endif; ?> class="button-secondary submit-add-to-menu right" value="<?php esc_attr_e( 'Add to Menu', 'listopia' ); ?>" name="add-custom-menu-item" id="submit-jvbpd-menu" />
