<?php
require( JVBPD_ADM_DIR . '/assets/fonts.php' ); ?>
<div class="jvbpd_ts_tab javo-opts-group-tab hidden" tar="font">
	<!-- Themes setting > Font -->
	<h2><?php esc_html_e("Fonts Settings", 'listopia' );?></h2>
	<table class="form-table">
	<tr><th>
		<?php esc_html_e('Basic Font', 'listopia' );?>
		<span class="description">
			<?php esc_html_e('Setup font size, tags', 'listopia' );?>
		</span>
	</th><td>
		<h4><?php esc_html_e("Choose basic font-family",'listopia' ); ?></h4>
		<fieldset>
		...
		<h4><?php esc_html_e("Normal Font size",'listopia' ); ?></h4>
		<fieldset>
		...
		<h4><?php esc_html_e("Line height",'listopia' ); ?></h4>
		<fieldset>
			<div style="width:400px; display:inline-block; margin:0 15px 0 0;">
		...
		<?php esc_html_e('H1', 'listopia' );?>
		<span class="description">
			<?php esc_html_e('Setup font size, tags', 'listopia' );?>
		</span>
	</th><td>
		<h4><?php esc_html_e("Choose H1 font-family",'listopia' ); ?></h4>
		<fieldset>
		...
		<h4><?php esc_html_e("H1 Font size",'listopia' ); ?></h4>
		<fieldset>
			<div style="width:400px; display:inline-block; margin:0 15px 0 0;">
	...
	<?php esc_html_e('H2', 'listopia' );?>
		<span class="description">
			<?php esc_html_e('Setup font size, tags', 'listopia' );?>
		</span>
	</th><td>
		<h4><?php esc_html_e("Choose H2 font-family",'listopia' ); ?></h4>
		<fieldset>
		...
		<h4><?php esc_html_e("H2 Font size",'listopia' ); ?></h4>
		<fieldset>
			<div style="width:400px; display:inline-block; margin:0 15px 0 0;">
	...
	<?php esc_html_e('H3', 'listopia' );?>
		<span class="description">
			<?php esc_html_e('Setup font size, tags', 'listopia' );?>
		</span>
	</th><td>
		<h4><?php esc_html_e("Choose H3 font-family",'listopia' ); ?></h4>
		<fieldset>
		...
		<h4><?php esc_html_e("H3 Font size",'listopia' ); ?></h4>
		<fieldset>
			<div style="width:400px; display:inline-block; margin:0 15px 0 0;">
		...
		<?php esc_html_e('H4', 'listopia' );?>
		<span class="description">
			<?php esc_html_e('Setup font size, tags', 'listopia' );?>
		</span>
	</th><td>
		<h4><?php esc_html_e("Choose H4 font-family",'listopia' ); ?></h4>
		<fieldset>
		...
		<h4><?php esc_html_e("H4 Font size",'listopia' ); ?></h4>
		<fieldset>
			<div style="width:400px; display:inline-block; margin:0 15px 0 0;">
		...
		<?php esc_html_e('H5', 'listopia' );?>
		<span class="description">
			<?php esc_html_e('Setup font size, tags', 'listopia' );?>
		</span>
	</th><td>
		<h4><?php esc_html_e("Choose H5 font-family",'listopia' ); ?></h4>
		<fieldset>
		...
		<h4><?php esc_html_e("H5 Font size",'listopia' ); ?></h4>
		<fieldset>
			<div style="width:400px; display:inline-block; margin:0 15px 0 0;">
		...
		<?php esc_html_e('H6', 'listopia' );?>
		<span class="description">
			<?php esc_html_e('Setup font size, tags', 'listopia' );?>
		</span>
	</th><td>
		<h4><?php esc_html_e("Choose H6 font-family",'listopia' ); ?></h4>
		<fieldset>
		...
		<h4><?php esc_html_e("H6 Font size",'listopia' ); ?></h4>
		<fieldset>
			<div style="width:400px; display:inline-block; margin:0 15px 0 0;">
