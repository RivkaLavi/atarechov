		...
		if ( have_rtmedia() ) : rtmedia();
			...
			<div id="rtmedia-single-media-container"
				...
				<?php } else { ?>
					...
					<span class="mfp-arrow mfp-arrow-left mfp-prevent-close rtm-lightbox-arrows" type="button" title="<?php esc_attr_e( 'Previous Media', 'listopia' ); ?>"></span>
					<span class="mfp-arrow mfp-arrow-right mfp-prevent-close" type="button" title="<?php esc_attr_e( 'Next Media', 'listopia' ); ?>"></span>
						...
						<div class='rtm-ltb-title'>
							...
							<?php if ( rtmedia_album_name() ) { ?>
								<span class="rtmedia-album-name">
									<span>&nbsp;<?php echo $media_under = apply_filters( 'rtmedia_update_under_album_text', esc_html__( 'under', 'listopia' ) ); ?></span>
