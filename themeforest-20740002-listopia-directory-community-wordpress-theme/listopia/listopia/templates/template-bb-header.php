...
<div class="jv-bbp-header" style="<?php echo esc_attr( $strFroumHeaderCSS ); ?>">
	<div class="jv-bbp-header-inner container">
		<h1 class="header-title"><?php esc_html_e( "Community forum", 'listopia' ); ?></h1>
		<?php
		...
		<div class="header-caption">
			...
			<?php if( 0 < intVal( $intBuddypressPage ) ) { ?>
				<div class="pull-right"><a href="<?php echo get_permalink( $intBuddypressPage ); ?>" class="btn btn-primary add-new-forum-form-link"><i class="jvbpd-icon-basic_sheet_pencil"></i> <?php esc_html_e('Add New Forum','listopia' ); ?></a></div>
			<?php } ?>
		</div>
	</div>
</div>