...
$navBackgroundID = intVal( $item->nav_bg );
$navBackground = wp_get_attachment_image_url( $navBackgroundID, 'full' );
$navBackground = $navBackground ? $navBackground : JVBPD_IMG_DIR . '/bg-my-menu.png'; ?>
...
<ul class="dropdown-menu dropdown-userinfo drop-right triangle-arrow-right">
	...
	<li class="my-menu-navs" style='background-image:url(<?php echo $navBackground; ?>);'>
		<?php
		wp_nav_menu( array(
			'menu'            => 'my_menu_nav',
...
<?php
	...
	printf(
		...
		'#login_panel', 'jvbpd-icon-user', esc_attr__( "Login", 'listopia' )
	);
endif;