				...
				<ul class="dropdown-menu dropdown-favorites fade-inout drop-right triangle-arrow-right">
					<li>
						<div class="card listing-card narrow">
							...
							<h4 class="card-title">
								<?php printf( esc_html__( "You have %s favorite listings", 'listopia' ), sizeof( array_filter( $arrFavorites ) ) ); ?>
							</h4>
						</div>
						...
						<div class="card-footer text-center">
							<a class="text-center" href="<?php echo jvbpd_getUserPage( jvbpd_getDashboardUser()->ID, 'favorite' ); ?>"> <?php esc_html_e( "See all saved listings", 'listopia' ); ?><i class="fa fa-angle-right"></i> </a>
						</div>
					</div>
					</li>
				</ul>
