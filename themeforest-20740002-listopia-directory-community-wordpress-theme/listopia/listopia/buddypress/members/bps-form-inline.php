...
<?php
		...
		switch ($f->display)
		{
			case 'range':
				if ($f->type == 'datebox')
				{
					...
					echo __('from', 'listopia' ). " <select style='width: auto;' name='{$f->code}_min' id='$f->code'>\n";
					echo "<option  value=''>". __('min', 'listopia' ). "</option>\n";
					for ($k=18; $k<100; $k++)
					{
					...
					echo __('to', 'listopia' ). " <select style='width: auto;' name='{$f->code}_max'>\n";
					echo "<option  value=''>". __('max', 'listopia' ). "</option>\n";
					for ($k=18; $k<100; $k++)
					{
	...
	echo "<input type='submit' value='". __('Search', 'listopia' ). "'>\n";
	echo "</div>\n";
	echo "</form>\n";
