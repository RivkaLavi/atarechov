...
<?php if ( !(int)bp_get_option( 'bp-disable-avatar-uploads' ) ) : ?>
	...
	<p><?php printf( __( 'Your profile photo will be used on your profile and throughout the site. If there is a <a href="%s">Gravatar</a> associated with your account email we will use that, or you can upload an image from your computer.', 'listopia' ), esc_url_raw( 'gravatar.com' ) ); ?></p>
	...
	<form action="" method="post" id="avatar-upload-form" class="standard-form" enctype="multipart/form-data">
		...
		<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
			...
			<?php if ( bp_get_user_has_avatar() ) : ?>
				...
				<p><a class="button edit" href="<?php bp_avatar_delete_link(); ?>"><?php _e( 'Delete My Profile Photo', 'listopia' ); ?></a></p>
			<?php endif; ?>
...
<?php else : ?>
	...
	<p><?php printf( __( 'Your profile photo will be used on your profile and throughout the site. To change your profile photo, please create an account with <a href="%s">Gravatar</a> using the same email address as you used to register with this site.', 'listopia' ), esc_url_raw( 'gravatar.com' ) ); ?></p>
