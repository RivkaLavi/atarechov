...
<?php
	...
	<div class="bp-widget wp-profile">
		<h2><?php bp_is_my_profile() ? _e( 'My Profile', 'listopia' ) : printf( __( "%s's Profile", 'listopia' ), bp_get_displayed_user_fullname() ); ?></h2>
		...
		<table class="wp-profile-fields table table-striped">
			...
			<?php if ( $ud->display_name ) : ?>
				...
				<tr id="wp_displayname">
					<td class="label"><?php _e( 'Name', 'listopia' ); ?></td>
			...
			<?php if ( $ud->user_description ) : ?>
				...
				<tr id="wp_desc">
					<td class="label"><?php _e( 'About Me', 'listopia' ); ?></td>
			...
			<?php if ( $ud->user_url ) : ?>
				...
				<tr id="wp_website">
					<td class="label"><?php _e( 'Website', 'listopia' ); ?></td>
			...
			<?php if ( $ud->jabber ) : ?>
				...
				<tr id="wp_jabber">
					<td class="label"><?php _e( 'Jabber', 'listopia' ); ?></td>
			...
			<?php if ( $ud->aim ) : ?>
				...
				<tr id="wp_aim">
					<td class="label"><?php _e( 'AOL Messenger', 'listopia' ); ?></td>
			...
			<?php if ( $ud->yim ) : ?>
				...
				<tr id="wp_yim">
					<td class="label"><?php _e( 'Yahoo Messenger', 'listopia' ); ?></td>
