	...
	<table class="notifications table table-striped">
		<thead>
			<tr>
				...
				<th class="title"><?php _e( 'Notification', 'listopia' ); ?></th>
				<th class="date"><?php _e( 'Date Received', 'listopia' ); ?></th>
				<th class="actions"><?php _e( 'Actions',    'listopia' ); ?></th>
			</tr>
		</thead>
			...
			<?php while ( bp_the_notifications() ) : bp_the_notification(); ?>
				...
				<tr>
					...
					<div class="checkbox">
						...
						_e( 'Select this notification', 'listopia' );
					?></span></label>
                                    </div>
					</td>
