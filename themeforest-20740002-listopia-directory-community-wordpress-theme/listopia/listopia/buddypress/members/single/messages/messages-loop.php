					...
					<tr id="m-<?php bp_message_thread_id(); ?>" class="<?php bp_message_css_class(); ?><?php if ( bp_message_thread_has_unread() ) : ?> unread<?php else: ?> read<?php endif; ?>">
						<td class="bulk-select-check">
							<div class="checkbox">
								...
								/* translators: accessibility text */
								_e( 'Select this message', 'listopia' );
							?></span></label>
							</div>
						</td>
						...
						<?php if ( 'sentbox' != bp_current_action() ) : ?>
							<td class="thread-from">
								...
								<span class="from"><?php _e( 'From:', 'listopia' ); ?></span> <?php bp_message_thread_from(); ?>
								<?php echo bp_get_message_thread_total_and_unread_count_number( bp_get_message_thread_id() ); ?>
							</td>
						<?php else: ?>
							<td class="thread-from">
								<?php bp_message_thread_avatar( array( 'width' => 25, 'height' => 25 ) ); ?>
								<span class="to"><?php _e( 'To:', 'listopia' ); ?></span> <?php bp_message_thread_to(); ?>
								<?php echo bp_get_message_thread_total_and_unread_count_number( bp_get_message_thread_id() ); ?>
							</td>
						<?php endif; ?>
...
<?php else: ?>
	...
	<div id="message" class="info">
		<p><?php _e( 'Sorry, no messages were found.', 'listopia' ); ?></p>
	</div>
