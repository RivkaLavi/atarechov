...
<form action="<?php bp_messages_form_action('compose' ); ?>" method="post" id="send_message_form" class="" enctype="multipart/form-data">
	...
	<div class="form-group">
		<p><input type="checkbox" id="send-notice" name="send-notice" value="1" /> <?php _e( "This is a notice to all users.", 'listopia' ); ?></p>
	</div>
	<?php endif; ?>
	...
	<ul class="first acfb-holder">
		<li>
			...
			<label for="send-to-input"><?php _e("Send To (Username or Friend's Name)", 'listopia' ); ?></label>
	...
	<div class="submit">
		<input type="submit" value="<?php esc_attr_e( "Send Message", 'listopia' ); ?>" name="send" id="send" />
	</div>
