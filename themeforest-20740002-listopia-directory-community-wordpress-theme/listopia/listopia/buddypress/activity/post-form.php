	...
	<div class="row">
		...
		<div class="col-md-11">
			<div class="form-group">
				...
				<label for="whats-new">
					<?php if ( bp_is_group() )
					printf( __( "What's new in %s, %s?", 'listopia' ), bp_get_group_name(), bp_get_user_firstname( bp_get_loggedin_user_fullname() ) );
					else
					printf( __( "What's new, %s?", 'listopia' ), bp_get_user_firstname( bp_get_loggedin_user_fullname() ) );
					?>						
		...
		<div id="whats-new-options2">
			...
			<div id="whats-new-submit">
				<input type="submit" name="aw-whats-new-submit" id="aw-whats-new-submit" value="<?php esc_attr_e( 'Post Update', 'listopia' ); ?>" />
			</div>
			...
			<?php if ( bp_is_active( 'groups' ) && !bp_is_my_profile() && !bp_is_group() ) : ?>
				<div id="whats-new-post-in-box">
					...
					<select id="whats-new-post-in" name="whats-new-post-in">
						<option selected="selected" value="0"><?php _e( 'My Profile', 'listopia' ); ?></option>
