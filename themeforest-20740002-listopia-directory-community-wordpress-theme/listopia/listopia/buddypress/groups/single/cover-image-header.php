	...
	<div id="item-header-cover-image">
				...
				<div class="tooltip-wrap">
					<div class="tooltip-body">
						<h3 class="tooltip-title"><i class="fa fa-info-circle"></i>
							<?php esc_html_e( "Description", 'listopia' ); ?>
						</h3>
					...
					<div class="tooltip-footer">
						...
						<span class="activity" data-livestamp="<?php bp_core_iso8601_date( bp_get_group_last_active( 0, array( 'relative' => false ) ) ); ?>">
							<?php printf( __( 'active %s', 'listopia' ), bp_get_group_last_active() ); ?>
						</span>
					</div>
				</div>
			</script>
		...
		<div id="item-actions">
			...
			<?php if ( bp_group_is_visible() ) : ?>
				...
				<h2><?php _e( 'Group Admins', 'listopia' ); ?></h2>
				...
				if ( bp_group_has_moderators() ) :
					...
					<h2><?php _e( 'Group Mods' , 'listopia' ); ?></h2>
...
<div class="container <?php echo esc_attr( $strContainerType ); ?>">
	<div id="item-nav">
		<div class="item-list-tabs no-ajax" id="object-nav" aria-label="<?php esc_attr_e( 'Group primary navigation', 'listopia' ); ?>" role="navigation">
