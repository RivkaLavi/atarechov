...
<h2 class="bp-screen-reader-text"><?php _e( 'Manage Group Details', 'listopia' ); ?></h2>
...
<p>
	<label for="group-notify-members">
		<input type="checkbox" name="group-notify-members" id="group-notify-members" value="1" /> <?php _e( 'Notify group members of these changes via email', 'listopia' ); ?>
	</label>
</p>
